...
object Scene1: _Scene
  ...
  object LED1: _LED
    ...
    Height = 40
    IsTransparent = True
    SignalName = 'eufs_can1_Updating.APPS_Status.Accelerator_Error_Flag'
    Caption = 'APPS Error'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object HorizontalBar2: _HorizontalBar
    ...
    Width = 176
    Height = 72
    SignalName = 'eufs_can1_Updating.APPS_Status.Accelerator_Pedal_position'
    Digit = 0
    LimitUpper = 90.000000000000000000
    LimitLower = -1.000000000000000000
    HintOptions = [hoValue, hoMin, hoMax, hoMinMaxDate, hoMinMaxTime]
    ...
    SignalSettings.DigitalTo = 100000
    SignalSettings.Name1 = 'Pedal Position'
    SignalSettings.Name2 = 'eufs_can1_Updating.APPS_Status.Accelerator_Pedal_position'
  ...
  object LED2: _LED
    ...
    Height = 40
    IsTransparent = True
    SignalName = 'eufs_can1_Updating.APPS_Status.Front_Brake_Line_Error_Flag'
  ...
  object LED4: _LED
    ...
    Height = 40
    IsTransparent = True
    SignalName = 'eufs_can1_Updating.APPS_Status.Accelerator_Active'
    Caption = 'APPS Active'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object LED3: _LED
    ...
    Height = 40
    IsTransparent = True
    SignalName = 'eufs_can1_Updating.APPS_Status.Brake_Throttle_Fault'
    Caption = 'Brake + Throttle Error'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
