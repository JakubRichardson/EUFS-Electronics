...
object Scene1: _Scene
  ...
  object LED2: _LED
    ...
    Height = 40
    IsTransparent = True
    SignalName = 'eufs_can2.APPS2VCU_Error_Flags.Accelerator_Error_Flag'
    Caption = 'APPS Error'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object HorizontalBar1: _HorizontalBar
    ...
    Width = 176
    Height = 72
    SignalName = 'eufs_can2.APPS2VCU_Front_Readings.Accelerator_Pedal_Position'
    Digit = 0
    LimitUpper = 90.000000000000000000
    LimitLower = -1.000000000000000000
    HintOptions = [hoValue, hoMin, hoMax, hoMinMaxDate, hoMinMaxTime]
    ...
    SignalSettings.Name2 = 'eufs_can2.APPS2VCU_Front_Readings.Accelerator_Pedal_Position'
    SignalSettings.ValueFormat = '##0.0'
